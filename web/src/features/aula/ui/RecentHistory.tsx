...
import { COIN_SIGN, coinSignKey }   from '@/config/scheme'
          ...
          return (
            <div key={l.id} className="flex items-start gap-3 p-2 group">
              <div className="mt-1.5 flex-shrink-0">
                <div className={cn('w-2 h-2 rounded-full ring-4 ring-zinc-950 group-hover:ring-zinc-900 transition-colors', sign.dot)} />
              </div>
